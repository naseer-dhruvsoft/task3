...
def count_of_objects():
  # url = "https://task3bucket.s3.ap-south-1.amazonaws.com/solar_system.jpg"
  url = "https://task3bucket.s3.ap-south-1.amazonaws.com/google_logo.jpg"
  ...
  print("The number of objects found in the given image: %s" %i)
